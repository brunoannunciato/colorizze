...
const Header = ({onLogoClick}) => {
    ...
    return (
        <div className="shadow-xl w-full flex justify-between padd p-5 z-10">
            ...
            <button onClick={onButtonClick} className="border-solid border-2 border-green-600 text-green-600 rounded-md py-1 px-2 font-bold">Create pallete</button>
        </div>
    )
}
